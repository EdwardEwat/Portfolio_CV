...
return new class extends Migration
{
    ...
    {
        Schema::create('du_an_cong_ty', function (Blueprint $table) {
            $table->id();
            $table->foreignId('congViecId')->constrained('cong_viec')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('du_an_cong_ty');
    }
};
